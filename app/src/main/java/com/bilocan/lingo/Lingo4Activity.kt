...
import com.bilocan.lingo.databinding.ActivityLingo4Binding
import com.bilocan.lingo.utils.CustomToast
import java.util.*
import android.app.AlertDialog

class Lingo4Activity : AppCompatActivity() {
    private lateinit var binding: ActivityLingo4Binding
    private lateinit var viewModel: LingoViewModel
    private lateinit var adapter: GuessAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLingo4Binding.inflate(layoutInflater)
        setContentView(binding.root)

        viewModel = ViewModelProvider(this, LingoViewModelFactory(application, 4))
    ...
    private fun setupViews() {
        binding.guessInput.filters = arrayOf(android.text.InputFilter.AllCaps(), android.text.InputFilter.LengthFilter(4))
    ...
    private fun setupObservers() {
        ...
        viewModel.gameState.observe(this) { gameState ->
            when (gameState) {
                ...
                GameState.ERROR -> {
                    CustomToast.show(this, "Lütfen 4 harfli bir kelime girin")
                }
    ...
    private fun setupClickListeners() {
        ...
        binding.nextWordButton.setOnClickListener {
            ...
            viewModel.resetGame()
            binding.guessInput.text?.clear()
            binding.guessInput.hint = "Lütfen 4 harfli bir kelime giriniz"
            binding.correctWordText.visibility = View.GONE
    ...
    private fun showExtraAttemptDialog() {
        val dialog = AlertDialog.Builder(this, R.style.LingoAlertDialog)
            .setCustomTitle(android.widget.TextView(this).apply {
                text = "Ek Hak"
                textSize = 20f
