...
class Lingo6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLingo6Binding.inflate(layoutInflater)
        setContentView(binding.root)

        viewModel = ViewModelProvider(this, LingoViewModelFactory(application, 6))
    ...
    private fun setupViews() {
        binding.guessInput.filters = arrayOf(android.text.InputFilter.AllCaps(), android.text.InputFilter.LengthFilter(6))
    ...
    private fun setupObservers() {
        ...
        viewModel.gameState.observe(this) { gameState ->
            when (gameState) {
                ...
                GameState.ERROR -> {
                    CustomToast.show(this, "Lütfen 6 harfli bir kelime girin")
                }
    ...
    private fun setupClickListeners() {
        ...
        binding.nextWordButton.setOnClickListener {
            ...
            viewModel.resetGame()
            binding.guessInput.text?.clear()
            binding.guessInput.hint = "Lütfen 6 harfli bir kelime giriniz"
            binding.correctWordText.visibility = View.GONE
